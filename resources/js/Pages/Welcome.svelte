        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a  use:inertia={{ href: '/diary-entries', method: 'get' }}
                        href="/diary-entries"
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Demo</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Sandbox demo for Laravel / Inertia / Svelte / Tailwind (and maybe supabase?)
                            </p>
                        </div>
